...
This document provides guidelines for internationalization of the Slimecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `slimecoin_en.ts` remains unchanged.
