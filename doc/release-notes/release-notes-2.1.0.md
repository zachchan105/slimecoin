Slimecoin Core version *2.1.0* is now available!!
==============

  <https://github.com/SlimecoinProject/Slimecoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/SlimecoinProject/Slimecoin/commits/release_2.1.0>
