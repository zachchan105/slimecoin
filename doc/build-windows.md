...
Below are some notes on how to build Slimecoin Core for Windows.
...
way. This will install to `c:\workspace\slimecoin`, for example:

    make install DESTDIR=/mnt/c/workspace/slimecoin
