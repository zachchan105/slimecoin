...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SlimecoinTestFramework
    pass

class ExampleTest(SlimecoinTestFramework):
    # Each functional test is a subclass of the SlimecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        SlimecoinTestFramework class so other tests can use it."""
