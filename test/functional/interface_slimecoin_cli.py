...
class TestSlimecoinCli(SlimecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `slimecoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `slimecoin-cli -getinfo` and the RPCs data is retrieved from.")
