...
class WalletTest(SlimecoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SLM from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 SLM with subtract fee from amount
        ...
        # Sendmany 10 SLM with subtract fee from amount
