...
By default, slimecoind will dump mempool on shutdown and
...
class MempoolPersistTest(SlimecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give slimecoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent slimecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
