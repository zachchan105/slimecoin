...
- Set the `self.setup_clean_chain` variable in `set_test_params()` to control whether
  ...
  has 25 mature blocks (25x5000=125000 SLM) in its wallet.
...
Taken from the [python-slimecoinrpc repository](https://github.com/jgarzik/python-slimecoinrpc).
...
Utilities for manipulating transaction scripts (originally from python-slimecoinlib)

#### [test_framework/key.py](test_framework/key.py)
Wrapper around OpenSSL EC_Key (originally from python-slimecoinlib)
