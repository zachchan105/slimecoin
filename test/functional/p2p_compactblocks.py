...
# TestNode: A peer we use to send messages to slimecoind, and store responses.
...
class CompactBlocksTest(SlimecoinTestFramework):
    ...
    # This test actually causes slimecoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that slimecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for slimecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # slimecoind will not send blocktxn responses for blocks whose height is
