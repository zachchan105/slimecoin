...
class BIP66Test(SlimecoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # slimecoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and slimecoind produces more specific reject
            # reasons.
