 ...
 */
#ifndef SLIMECOIN_UTIL_H
#define SLIMECOIN_UTIL_H
...
extern const char *const SLIMECOIN_CONF_FILENAME;
extern const char *const SLIMECOIN_PID_FILENAME;
...
{
    std::string s = strprintf("slimecoin-%s", name);
