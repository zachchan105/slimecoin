...
#ifndef SLIMECOIN_TEST_SCRIPTNUM10_H
#define SLIMECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Slimecoin Core 0.10.0, for cross-comparison.
 */
public:
