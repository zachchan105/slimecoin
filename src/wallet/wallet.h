...
#ifndef SLIMECOIN_WALLET_WALLET_H
#define SLIMECOIN_WALLET_WALLET_H
...
public:
     ...
     * on this slimecoin node, and set to 0 for transactions that were created
...
public:
    ...
    /**
     * Helper function that calls AvailableCoinsAll, used to receive all coins, Assets and SLM
     */
...
#endif // SLIMECOIN_WALLET_WALLET_H
