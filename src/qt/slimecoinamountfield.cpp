...
public:
    explicit AmountSpinBox(QWidget *parent):
        ...
        currentUnit(SlimecoinUnits::SLM),
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int h = lineEdit()->minimumSizeHint().height();
            	...
            	int w = fm.horizontalAdvance(SlimecoinUnits::format(SlimecoinUnits::SLM, SlimecoinUnits::maxMoney(), false, SlimecoinUnits::separatorAlways, assetUnit));
			#else
				int w = fm.width(SlimecoinUnits::format(SlimecoinUnits::SLM, SlimecoinUnits::maxMoney(), false, SlimecoinUnits::separatorAlways, assetUnit));
			#endif
