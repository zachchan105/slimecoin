...
#ifndef SLIMECOIN_QT_RECEIVECOINSDIALOG_H
#define SLIMECOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of slimecoins */
...
#endif // SLIMECOIN_QT_RECEIVECOINSDIALOG_H
