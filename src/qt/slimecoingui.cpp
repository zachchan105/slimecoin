...
void SlimecoinGUI::createActions()
{
    ...
    transferAssetAction->setStatusTip(tr("Transfer assets to SLM addresses"));
...
void SlimecoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        if(IconsOnly) {
            ...
            labelToolbar->setPixmap(QPixmap::fromImage(QImage(":/icons/slimecoincointext")));
        }
...
//        m_toolbar->addAction(votingAction);
        ...
        QVBoxLayout* slimecoinLabelLayout = new QVBoxLayout(toolbarWidget);
        slimecoinLabelLayout->addWidget(labelToolbar);
        slimecoinLabelLayout->addWidget(m_toolbar);
        slimecoinLabelLayout->addStretch(1);
        slimecoinLabelLayout->addWidget(slimecoinLabel);
        slimecoinLabelLayout->addWidget(versionLabel);  // Add the QLabel for version
        slimecoinLabelLayout->setDirection(QBoxLayout::TopToBottom);
        ...
        labelVersionUpdate->setText("<a href=\"https://github.com/SlimecoinProject/Slimecoin/releases\">New Wallet Version Available</a>");
        ...
        // Hide the "SLM Market Price" label and dropdown
                       ...
                       if (key == "tag_name") {
                           ...
                           if (fNewSoftwareFound) {
                               ...
                               if (GetRandInt(2) == 1) {
                                   ...
                                   if (fRet) {
                                       QString link = "https://github.com/SlimecoinProject/Slimecoin/releases";
...
void SlimecoinGUI::checkAssets()
{
    ...
    if(AreAssetsDeployed()) {
        ...
        transferAssetAction->setToolTip(tr("Transfer assets to SLM addresses"));
...
{
    versionRequest->setUrl(QUrl("https://api.github.com/repos/SlimecoinProject/Slimecoin/releases"));
