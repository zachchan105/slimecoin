...
#include "qt/slimecoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SlimecoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_slimecoin-qt -platform xcb      # Linux
//     src/qt/test/test_slimecoin-qt -platform windows  # Windows
//     src/qt/test/test_slimecoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SlimecoinUnits::formatWithUnit(unit, balance, false, SlimecoinUnits::separatorAlways);
    ...
    // Amount input
    SlimecoinAmountField* amountInput = receiveCoinsDialog.findChild<SlimecoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: slimecoin:")) != -1);
